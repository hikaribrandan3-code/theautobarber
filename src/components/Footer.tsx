          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              {["Home", "Services", "Gallery", "FAQ", "Contact"].map(l => (
                <Link key={l} to={l === "Home" ? "/" : `/${l.toLowerCase()}`} className="text-white text-sm font-bold hover:text-[#C9A962] transition-colors uppercase tracking-widest">{l}</Link>
              ))}
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4 pt-2">
                <a href="https://instagram.com/Area51DetailingLLC" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#C9A962] transition-colors">
                  <Instagram size={24} />
                </a>
              </div>
            </div>
