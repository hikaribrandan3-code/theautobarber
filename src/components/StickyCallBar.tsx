...
const StickyCallBar = () => {
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 lg:hidden px-4 pb-4 pointer-events-none animate-in slide-in-from-bottom duration-500 delay-500">
      <a 
        href="tel:2538939452" 
        className="flex items-center justify-between w-full bg-[#0066FF] text-white px-6 py-4 rounded-none shadow-[0_15px_40px_rgba(0,102,255,0.4)] pointer-events-auto active:scale-95 transition-all border border-white/10"
      >
